...
//			throw new IllegalArgumentException("輸入錯誤! 貨物編號、貨物描述不可以是空字串!! 請重新輸入..");
//		}
//		
//		if(pricePerItem <0.0) {
...
//		this.quantity = quantity;
	...
	public void setPartNumber(String partNumber){
		if(partNumber.equals("")) {
			throw new IllegalArgumentException("輸入錯誤! 貨物編號不可以是空字串!! 請重新輸入..");
		}
		this.partNumber = partNumber;
	}
	...
	public void setPartDescription(String partDescription) {
		if(partDescription.equals("")) {
			throw new IllegalArgumentException("輸入錯誤!貨物描述不可以是空字串!! 請重新輸入..");
		}
		this.partDescription = partDescription;
	}
